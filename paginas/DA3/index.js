...
p.nominalBounds = new cjs.Rectangle(-5.2,-1.2,811.2,79);
...
p.nominalBounds = new cjs.Rectangle(-6.1,0,791.8,63);
...
p.nominalBounds = new cjs.Rectangle(-4.4,-1.8,767.4,51.8);
...
p.nominalBounds = new cjs.Rectangle(-3.4,0,321.5,143.5);
...
p.nominalBounds = new cjs.Rectangle(-437.5,-79,875,158);
...
p.nominalBounds = new cjs.Rectangle(-5.3,-6.8,497,59);
...
p.nominalBounds = new cjs.Rectangle(-2.8,-4.3,240.5,56);


// stage content:
(lib.DA3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_104 = function() {
		...
		function() {
			//call modal
			visto[0] = 2;
			parent.course.createModal("paginas/DA3a/index.html?myParam="+ nextTela(), 875, 520, false , false);
		...
		function() {
			//call modal
			visto[1] = 2;
			parent.course.createModal("paginas/DA3b/index.html?myParam="+ nextTela(), 875, 520, false , false);
	...
	this.instance_4.setTransform(437.5,601);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(66).to({_off:false},0).wait(1).to({y:600.2},0).wait(1).to({y:597.5},0).wait(1).to({y:592.4},0).wait(1).to({y:583.9},0).wait(1).to({y:570.7},0).wait(1).to({y:551.1},0).wait(1).to({y:524.9},0).wait(1).to({y:497.2},0).wait(1).to({y:475.2},0).wait(1).to({y:460.1},0).wait(1).to({y:450.5},0).wait(1).to({y:444.8},0).wait(1).to({y:441.8},0).wait(1).to({y:441},0).wait(25));
