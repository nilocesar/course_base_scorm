...
(lib.Símbolo5 = function() {
	...
	this.shape.graphics.f("rgba(255,255,255,0.8)").s().p("Eg82AT6MAAAgn0MB5tAAAMAAAAn0g");
	this.shape.setTransform(389.5,127.5);
...
(lib._01 = function(mode,startPosition,loop) {
	...
	this.frame_54 = function() {
		...
		_chamar.on("click", 
		function() {
			parent.course.createModal("paginas/DA4a/index.html", 875, 520, false);
		});
	}
...
(lib.DA4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_121 = function() {
		...
		if(  parent.course.getData("dialogo2") != "1" ){
			this["btn1"].on("click", 
			function() {
				_this["pop"].play();
			});
	...
	this.timeline.addTween(cjs.Tween.get(this.pop).wait(119).to({_off:false},0).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(107).to({_off:false},0).wait(1).to({regX:85.4,regY:28.6,x:434.2,y:455.6,alpha:0.012},0).wait(1).to({y:454,alpha:0.051},0).wait(1).to({y:450.9,alpha:0.13},0).wait(1).to({y:445.7,alpha:0.258},0).wait(1).to({y:438.6,alpha:0.436},0).wait(1).to({y:431,alpha:0.627},0).wait(1).to({y:424.7,alpha:0.784},0).wait(1).to({y:420.4,alpha:0.892},0).wait(1).to({y:417.8,alpha:0.957},0).wait(1).to({y:416.4,alpha:0.99},0).wait(1).to({regX:0,regY:0,x:348.8,y:387.5,alpha:1},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(18).to({_off:false},0).to({alpha:1},13).wait(91));

	// Camada 1
	this.instance_5 = new lib.DA4_1();
	this.instance_5.setTransform(0,0,1,1.04);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(122));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(437.5,260,1212,540.8);
