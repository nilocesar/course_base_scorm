...
(lib.txt2 = function() {
	...
	this.instance.setTransform(-3.1,-1,0.712,0.712);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-3.1,-1,311.8,194);
...
// stage content:
(lib.EA6 = function(mode,startPosition,loop) {
	...
	this.frame_62 = function() {
		...
		this["btAnalise"].on("click", function(){
			parent.course.createModal("paginas/EA6a/index.html", 875, 520, false, false);
		});
	}
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(36).to({_off:false},0).wait(1).to({regX:152.8,regY:66.3,x:243.4,y:314.4,alpha:0.017},0).wait(1).to({y:314,alpha:0.034},0).wait(1).to({y:313.3,alpha:0.068},0).wait(1).to({y:312.1,alpha:0.122},0).wait(1).to({y:310.2,alpha:0.207},0).wait(1).to({y:307.5,alpha:0.33},0).wait(1).to({y:303.9,alpha:0.49},0).wait(1).to({y:300.2,alpha:0.655},0).wait(1).to({y:297.3,alpha:0.788},0).wait(1).to({y:295.2,alpha:0.88},0).wait(1).to({y:293.9,alpha:0.94},0).wait(1).to({y:293.1,alpha:0.976},0).wait(1).to({y:292.7,alpha:0.995},0).wait(1).to({regX:174,regY:79,x:264.6,y:305.3,alpha:1},0).wait(13));
