...
(lib.txt2 = function() {
	...
	this.instance.setTransform(-11,-6.9,0.712,0.712);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-11,-6.9,323.3,199.9);
...
// stage content:
(lib.CA6 = function(mode,startPosition,loop) {
	...
	this.frame_62 = function() {
		...
		this["btAnalise"].on("click", function(){
			parent.course.createModal("paginas/CA6a/index.html", 875, 520, false, false);
		});
	}
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(36).to({_off:false},0).wait(1).to({regX:150.6,regY:65,x:241.2,y:313.1,alpha:0.017},0).wait(1).to({y:312.7,alpha:0.034},0).wait(1).to({y:312,alpha:0.068},0).wait(1).to({y:310.8,alpha:0.122},0).wait(1).to({y:308.9,alpha:0.207},0).wait(1).to({y:306.2,alpha:0.33},0).wait(1).to({y:302.6,alpha:0.49},0).wait(1).to({y:298.9,alpha:0.655},0).wait(1).to({y:296,alpha:0.788},0).wait(1).to({y:293.9,alpha:0.88},0).wait(1).to({y:292.6,alpha:0.94},0).wait(1).to({y:291.8,alpha:0.976},0).wait(1).to({y:291.4,alpha:0.995},0).wait(1).to({regX:174,regY:79,x:264.6,y:305.3,alpha:1},0).wait(13));
	...
	// Camada 1
	this.instance_3 = new lib.CA6_1();
	this.instance_3.setTransform(-3,-4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(63));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(434.5,256,880,530);
